...
namespace ClassVision.Data.Migrations
{
    ...
    [Migration("20250223084200_AddMediaToStudent")]
    partial class AddMediaToStudent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClassVision.Data.Entities.Course", b =>
                {
                    ...
                    b.HasOne("ClassVision.Data.Entities.AppUser", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("ClassVision.Data.Entities.Enrollment", b =>
                {
                    ...
                    b.HasOne("ClassVision.Data.Entities.Schedule", null)
                        .WithMany("Enrollments")
                        .HasForeignKey("ScheduleId");
