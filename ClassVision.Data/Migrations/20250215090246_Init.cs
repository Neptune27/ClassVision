        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseInfoId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<int>(type: "integer", nullable: false),
                    Birthday = table.Column<DateOnly>(type: "date", nullable: false),
                    EnrollAt = table.Column<DateOnly>(type: "date", nullable: false),
                    PhoneNumber = table.Column<string>(type: "text", nullable: false),
                    Address = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendants", x => new { x.CourseId, x.StudentId, x.ScheduleId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Attendants_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendants_ScheduleId",
                table: "Attendants",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_Attendants_StudentId",
                table: "Attendants",
                column: "StudentId");
