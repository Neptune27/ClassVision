...
namespace ClassVision.Data.Migrations
{
    ...
    [Migration("20250415091206_CourseAddArchived")]
    partial class CourseAddArchived
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassVision.Data.Entities.ClassUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.PrimitiveCollection<List<DateTimeOffset>>("LoginTime")
                        .IsRequired()
                        .HasColumnType("timestamp with time zone[]");
            ...
            modelBuilder.Entity("ClassVision.Data.Entities.Attendant", b =>
                {
                    b.HasOne("ClassVision.Data.Entities.ClassUser", null)
                        .WithMany("Attendants")
            ...
            modelBuilder.Entity("ClassVision.Data.Entities.Course", b =>
                {
                    b.HasOne("ClassVision.Data.Entities.ClassUser", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("ClassVision.Data.Entities.Enrollment", b =>
                {
                    ...
                    b.HasOne("ClassVision.Data.Entities.ClassUser", "Student")
                        .WithMany("Enrollments")
